...
public class ServicoMunicipalMapping : IEntityTypeConfiguration<ServicoMunicipal>
{
    public void Configure(EntityTypeBuilder<ServicoMunicipal> builder)
    {
        ...
        builder.Property(s => s.Valor).IsRequired().HasColumnType("decimal(18, 2)");
        builder.Property(s => s.ValorMulta).IsRequired().HasColumnType("decimal(18, 2)");
        builder.Property(s => s.ValorJuros).IsRequired().HasColumnType("decimal(18, 2)");
        builder.Property(s => s.ValorTotal).IsRequired().HasColumnType("decimal(18, 2)");
